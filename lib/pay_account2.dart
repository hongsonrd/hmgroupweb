...
class PayAccountScreen2 extends StatefulWidget {
  final String username;
  final String userRole;
  final List<Map<String, dynamic>> accountData;

  const PayAccountScreen2({
    Key? key,
  ...
  @override
  State<PayAccountScreen2> createState() => _PayAccountScreen2State();
}

class _PayAccountScreen2State extends State<PayAccountScreen2> {
                  ...
                  return Padding(
                    ...
                    child: TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (entry.key == 'Password' && (value.length < 6 || value.length > 10)) {
                          return 'Mật khẩu phải từ 6-10 ký tự';
                        }
                        if (entry.key == 'Username' && _isDuplicateUsername(value)) {
                          return 'Username đã tồn tại';
                        }
                        if (entry.key == 'UserID' && _isDuplicateUserID(value)) {
          ...
          ElevatedButton(
            onPressed: () {
              if (formKey.currentState!.validate()) {
                _confirmCreateAccount(controllers);
              }
            },
  ...
  void _confirmCreateAccount(Map<String, TextEditingController> controllers) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
  ...
  Future<void> _createAccount(Map<String, TextEditingController> controllers) async {
    try {
      final data = {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Lỗi khi tạo tài khoản')),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _stopAccount(String username) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Lỗi khi dừng tài khoản')),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
...
Nút dừng tài khoản sẽ đăng xuất trên thiết bị, hãy sử dụng cẩn thận!''',
  ...
  void _showEditAccountDialog(Map<String, dynamic> account) {
    ...
    final controllers = {
      ...
      'BP': TextEditingController(text: account['BP']?.toString() ?? ''),
    };
                  ...
                  return Padding(
                    ...
                    child: TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (entry.key == 'Username' && _isDuplicateUsername(value, originalUsername)) {
                          return 'Username đã tồn tại';
                        }
                        if (entry.key == 'UserID' && _isDuplicateUserID(value, originalUserID)) {
                          return 'User ID đã tồn tại';
                        }
                        return null;
                      },
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              if (formKey.currentState!.validate()) {
                Navigator.pop(context);
                _updateAccount(originalUsername, controllers);
              }
            },
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              if (formKey.currentState!.validate()) {
                Navigator.pop(context);
                _updatePassword(account['Username']?.toString() ?? '', controller.text);
              }
            },
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              if (formKey.currentState!.validate()) {
                Navigator.pop(context);
                _reactivateAccount(account['Username']?.toString() ?? '', controller.text);
              }
            },
  ...
  Future<void> _updateAccount(String originalUsername, Map<String, TextEditingController> controllers) async {
    try {
      final data = {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Lỗi khi cập nhật tài khoản')),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _updatePassword(String username, String newPassword) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Lỗi khi đổi mật khẩu')),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _reactivateAccount(String username, String avatarValue) async {
    try {
      final data = {
        'Username': username,
        'Avatar': avatarValue,
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Lỗi khi kích hoạt tài khoản')),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
