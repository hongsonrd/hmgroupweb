...
import 'projectmanagement4xacnhan.dart';
...
Row(
  mainAxisAlignment: MainAxisAlignment.spaceBetween,
  children: [
    // Only show confirm button if status is "Chờ xác nhận" and user is Admin
    if (request.xacNhan == 'Chờ xác nhận' && _userProfile?.phanLoai == 'Admin')
      ElevatedButton(
        onPressed: () {
