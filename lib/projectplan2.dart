...
class ProjectPlan2 extends StatefulWidget {
  final String? userType;
  final String? selectedBoPhan;
  final String? selectedDate;
  ProjectPlan2({this.selectedDate, this.selectedBoPhan, this.userType});
  @override
  _ProjectPlan2State createState() => _ProjectPlan2State();
}

class _ProjectPlan2State extends State<ProjectPlan2> with SingleTickerProviderStateMixin {
                              ...
                              onPressed: () async {
                                try {
                                  ...
                                  final reportData = {
                                    ...
                                    'giaiPhapChung': _giaiPhapController.text,
                                    'chiaSe': plan.chiaSe,
                                    'nhom': 'Báo cáo',
                                    'phatSinh': 'Có',
                                    'xetDuyet': 'Chưa duyệt',
