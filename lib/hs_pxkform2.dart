                 ...
                 pw.Table(
                   ...
                   children: [
                     pw.TableRow(
                       ...
                       children: [
                         _buildTableCell('Product Name', ttf, isBold: true),
                         _buildTableCell('Note', ttf, isBold: true),
                         _buildTableCell('Code', ttf, isBold: true),
                         _buildTableCell('Unit', ttf, isBold: true),
                         _buildTableCell('Quantity', ttf, isBold: true),
                         _buildTableCell('Price', ttf, isBold: true),
