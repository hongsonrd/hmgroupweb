  ...
  void _calculateDateRange() {
    switch (_selectedPeriodType) {
      ...
      case 'Quý':
        ...
        _endDate = DateTime(_selectedYear, startMonth + 3, 0);
        break;
      case 'Năm':
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Text(
              'Khoảng thời gian: ${DateFormat('dd/MM/yyyy').format(_startDate)} - ${DateFormat('dd/MM/yyyy').format(_endDate)}',
