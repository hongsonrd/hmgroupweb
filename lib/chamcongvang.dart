...
class ChamCongVangScreen extends StatefulWidget {
  final String username;
  final String userRole;
  final String approverUsername;
  final ChamCongScreenType screenType;

  const ChamCongVangScreen({
    Key? key,
    required this.username,
    required this.userRole,
    required this.approverUsername,
    this.screenType = ChamCongScreenType.vang,
  }) : super(key: key);

  @override
  _ChamCongVangScreenState createState() => _ChamCongVangScreenState();
}

class _ChamCongVangScreenState extends State<ChamCongVangScreen> with SingleTickerProviderStateMixin {
