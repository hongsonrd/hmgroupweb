            ...
            child: Column(
              ...
              children: [
                ...
                _buildInfoRow('Ghi chú:', _orderDetails!.ghiChu ?? 'N/A'),
                     _buildInfoRow('Địa chỉ giao hàng', _orderDetails!.diaChiGiaoHang ?? ''),
                     _buildInfoRow('Người nhận hàng', _orderDetails!.nguoiNhanHang ?? ''),
                          _buildInfoRow('SĐT người nhận', _orderDetails!.sdtNguoiNhanHang ?? ''),
              ],
            ),
          ),
        ),
